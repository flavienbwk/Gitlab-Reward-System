...
CREATE TABLE IF NOT EXISTS `gitlabrs`.`User` (
  ...
  `password` VARCHAR(128) NULL COMMENT 'Password set if the user is signed up (requires the user to be admin in the API (is_admin)).\nAfter setup, only the first admin account can set a password for the other admin users.',
